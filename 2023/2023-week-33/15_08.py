# TidyTuesday, week 33 of 2023, creator: Ioannis Doganos
...
# Load custom fonts (not all fonts are used)
...
ax1.set_ylim(0, 100)
# Change the tick labels in order to show as percentage
# First set the ticks because of a bug in matplotlib that shows a warning message
# Solution found: https://stackoverflow.com/questions/63723514/userwarning-fixedformatter-should-only-be-used-together-with-fixedlocator
ax1.set_yticks(list(range(20, 120, 20)))
...
# Change the figure's background to mach the plot's background
...
# ---- Title and Subtitle ----
fig3, ax4 = plt.subplots(figsize = (12, 4.5))

ax4.text(0.5, 0.9, 'Characteristics of', fontsize = 30, color = labels_color, ha = 'center', font = alfaslabpath)
ax4.text(0.44, 0.4, 'NO ', fontsize = 100, color = green_general, ha = 'right', font = alfaslabpath)
ax4.text(0.44, 0.4, '$PAM',fontsize = 100, color = red_general, ha = 'left', font = alfaslabpath)
ax4.text(0.5, 0.08, '''Spam emails tend to be  l o n g e r,
mention more the term "make money" or include special characters like the ! and the $''',
        fontsize = 25, color = labels_color, ha = 'center', va = 'center', font = handjetlightpath)
# Remove the axis
